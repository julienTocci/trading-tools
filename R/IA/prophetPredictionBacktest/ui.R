...
fluidPage(
  ...
  fluidRow(
    column(3, wellPanel(
      ...
      helpText("You can choose the initial date for the train period (ending date should be set in the code). We forecast price starting at the end of the training period (green color same direction, red color different)."),
      dateInput("date", "Initial Date:", "2007-01-01", max="2020-02-21"),
